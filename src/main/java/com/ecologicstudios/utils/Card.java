 ...
 * <p>
 * Each Card contains a unique identifier, a scenario description, a difficulty
 * level,
 * and a list of possible alternatives (choices) with associated CO2 emission
 * values.
 * Cards are used to present environmental scenarios to players and collect
 * their
...
public class Card {
     ...
     * @param scenario     the environmental scenario description to present to the
     *                     player
     * @param difficulty   the difficulty level (e.g., "Easy", "Medium", "Hard")
     * @param alternatives the list of alternative choices available for this
     *                     scenario
     */
